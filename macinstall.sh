...
# Set fast key Reveal IP address, hostname, OS version, etc. when clicking the clock rate
...
# Stop iTunes from responding to the keyboard media keys - doesn't work 2019 09
